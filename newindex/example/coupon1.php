...
function hert(){
    ...
    <div class="content" style="background:white">
        ...
        <img style="max-width:100%;max-height:100%; position:absolute;" src="http://www.babyinbook.com/babyinbook/images/newcoupon<?php echo $value['status']; ?>.png" />
