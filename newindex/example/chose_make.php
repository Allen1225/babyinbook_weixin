...
<body>
<div class="content">
    <a href="select.php?id=61&a=1" >
        <div style="width:100%;padding-top:2px;padding-bottom: 2px;margin-top: 10px;">
            <img style="width:90%;margin-left:5%;" src="http://www.babyinbook.com/babyinbook/img/chose_0.png" />
        </div>
    </a>
    <a href="../cand.php" >
        <div style="width:100%;padding-top:2px;padding-bottom: 2px;margin-top: 10px;">
            <img style="width:90%;margin-left:5%;" src="http://www.babyinbook.com/babyinbook/img/chose_1.png" />
        </div>
    </a>
</div>
